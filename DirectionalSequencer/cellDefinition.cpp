...
const CellDefinition CellDefinition::All[static_cast<uint16_t>(CellDataType::NumCellDataTypes)] = {
	...
	{ "Value",       "Value",        0, 10,  5,   kNT_unitVolts,   kNT_scaling1000, 10, "Step Value, 0-10V. Off/Atten in parameters" },
	...
	{ "MaxDrift",    "Max Drift",    0, 10,  0,   kNT_unitVolts,   kNT_scaling1000, 15, "Max amount the value will drift by, 0-10V" },
	...
	{ "AccumAdd",    "Accum Add",   -1, 1,   0,   kNT_unitVolts,   kNT_scaling1000,  5, "How much gets added to this cell each visit" },
